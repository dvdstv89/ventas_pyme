...
{
    public class VentaResumidaComplejoDia
    {
        ...
        public VentaResumidaComplejoDia(Complejo tienda, Atributo_Mes mes, int dia, Atributo_Money planDiario, Atributo_Money planAcumulado, Atributo_Money realAcumulado)
        {
            this.complejo = tienda;
            this.mes= mes; 
