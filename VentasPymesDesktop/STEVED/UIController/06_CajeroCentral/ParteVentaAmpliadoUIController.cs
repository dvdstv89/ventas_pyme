...
{
    internal class ParteVentaAmpliadoUIController
    {
        GrupoTienda grupoTienda;
        Complejo complejo;
        List<Tienda> tiendas;
        List<FormaPago> formasPago;
        ParteVentaAmpliadoUI forma;
        Moneda monedaByDefault;
        Moneda monedaDeLaTienda;
        DateTime fecha;       
        DataGridPartesVentas dataGridPartesVentas;
        Session session;      
        public ParteVentaAmpliadoUIController(Session session, Complejo complejo, GrupoTienda grupoTienda, Moneda moneda)
        {
            ...
            formasPago = FormaPagoData.getByMoneda(monedaDeLaTienda);            
            forma = new ParteVentaAmpliadoUI();
        ...
        public ParteVentaAmpliadoUI Ejecutar()
        {
        ...
        private void inicializarFecha()
        {
            try
            {
                fecha = complejo.getFechaUltimoParteVenta(monedaDeLaTienda).Fecha;
