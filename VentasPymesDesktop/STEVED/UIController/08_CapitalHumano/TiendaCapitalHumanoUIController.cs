...
namespace NucleoEV.UIController
{
    internal class TiendaCapitalHumanoUIController
    {
      ...
      //  protected List<Complejo> complejos;
        ...
        public TiendaCapitalHumanoUIController(Session session, Complejo complejo, GrupoTienda grupoTienda, Tienda tienda)
        {
            try
            {
                ...
                this.formasPagos= FormaPagoData.getFormasPagos(grupoTienda.isOnline.Value);
                this.complejo = complejo;
                this.monedas = MonedaData.getAllMonedas(grupoTienda.isOnline.Value);
            }
            catch (Exception ex)
            {
        ...
        {
            if (moneda == null) this.formasPagos = FormaPagoData.getFormasPagos(grupoTienda.isOnline.Value);
        ...
        protected bool actualizarTiendaDesdeFormulario()
        {
            ...
            {   
               ...
               // tienda.isTiendaOnline.Value = forma.cbEsTiendaOnline.Checked;               
