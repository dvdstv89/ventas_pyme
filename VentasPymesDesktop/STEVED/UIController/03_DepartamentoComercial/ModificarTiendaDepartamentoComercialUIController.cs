...
{
    internal class ModificarTiendaDepartamentoComercialUIController : TiendaUIController
    {
       
        public ModificarTiendaDepartamentoComercialUIController(Session session, Tienda tienda, List<Complejo> listaComplejos) : base(session, listaComplejos, tienda)
        {
