...
{
    internal class GestionarDepartamentoComercialUIController : BaseUIController, IController<GestionarDepartamentoComercialUI>
    {
        ...
        public GestionarDepartamentoComercialUIController(Session session, MainUIController mainUI) : base(session, new GestionarDepartamentoComercialUI())
        {
            try
            {               
                this.mainUI = mainUI;                
        ...
        public GestionarDepartamentoComercialUI Ejecutar()
        {
        ...
        public GestionarDepartamentoComercialUI getForma()
        {
            return forma as GestionarDepartamentoComercialUI;
        }
