...
namespace NucleoEV.UIController
{
    internal class TiendaUIController
    {
        ...
        private void UpdateListMonedas(GrupoTienda grupoTienda)
        {
            this.listaMonedas = MonedaData.getAllMonedas(grupoTienda.isOnline.Value);
            this.monedaSeleccionado = listaMonedas[0];
        }
        private void UpdateListFormasPagos(GrupoTienda grupoTienda)
        {
            this.listaFormasPagos = FormaPagoData.getFormasPagos(grupoTienda.isOnline.Value);
        }
    }
}
